...
parser = argparse.ArgumentParser(description="Test_Rain1400")
parser.add_argument("--logdir", type=str, default="logs/Rain1400", help='path of log files')
parser.add_argument("--data_path", type=str, default="./datasets/test/Rain1400.2", help='path to test data')
parser.add_argument("--save_path", type=str, default="results/Rain1400", help='path to save results')
...
def main():
    ...
    files_source = glob.glob(os.path.join(opt.data_path, 'rainy/*.jpg'))
    target_source = glob.glob(os.path.join(opt.data_path, 'norain/*.jpg'))
    print(files_source)
    print(target_source)
    # print('--------------------files_source------------------')
    # print(files_source)
