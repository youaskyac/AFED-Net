...
parser = argparse.ArgumentParser(description="Test_Rain1200")
parser.add_argument("--logdir", type=str, default="logs/Rain1200/", help='path of log files')
parser.add_argument("--data_path", type=str, default="./datasets/test/Rain1200", help='path to test data')
parser.add_argument("--save_path", type=str, default="results/Rain1200", help='path to save results')
