...
import time
parser = argparse.ArgumentParser(description="Test_Rain100L")
parser.add_argument("--logdir", type=str, default="logs/Rain100L", help='path of log files')
parser.add_argument("--data_path", type=str, default="./datasets/test/Rain100L", help='path to test data')
parser.add_argument("--save_path", type=str, default="results/Rain100L", help='path to save results')
...
def main():
    ...
    files_source = glob.glob(os.path.join(opt.data_path, 'resizetest_rain/*.png'))
    target_source = glob.glob(os.path.join(opt.data_path, 'resizetest/*.png'))
    print(files_source)
    print(target_source)
    # print('--------------------files_source------------------')
    # print(files_source)
